Create a WorkflowShell component in features/workflows/components/ that takes a workflowId and is the layout shell for the workflow editor, then render it from the workflow workflows/$id page
